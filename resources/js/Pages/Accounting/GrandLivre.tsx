...
export default function GrandLivre({ activeTab }: PageProps<{ activeTab: string }>) {
    const tabs = [
    ...
    return (
        <ErpLayout>
            ...
            <div className="py-2">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Grand Livre</h1>
                <Tabs tabs={tabs} />
