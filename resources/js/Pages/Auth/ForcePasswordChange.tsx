    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
            ...
            <div className="max-w-4xl w-full bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
                <div className="md:w-1/2 bg-white p-8 flex items-center justify-center border-b md:border-b-0 md:border-r border-gray-100">
                    <img src="/images/branding.png" alt="FIDUCIA AFRIC" className="w-full max-w-sm h-auto object-contain" />
                </div>

                <div className="md:w-1/2">
                    <div className="p-6 pb-0 text-center md:text-left">
